...
import dishesAdd from './ScheduleTemplateAdd.vue'
import dishesEdit from './ScheduleTemplateEdit.vue'
import dishesView from './ScheduleTemplateView.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/schedule-template-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/schedule-template-info/page', {
        ...params
      }).then((r) => {
