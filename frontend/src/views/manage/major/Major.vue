          ...
          <div :class="advanced ? null: 'fold'">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.tieName"/>
              </a-form-item>
            </a-col>
          </div>
...
import dishesAdd from './MajorAdd.vue'
import dishesEdit from './MajorEdit.vue'
import dishesView from './MajorView.vue'
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/major-info/' + ids).then(() => {
