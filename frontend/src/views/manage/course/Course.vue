...
import dishesAdd from './CourseAdd.vue'
import dishesEdit from './CourseEdit.vue'
import dishesView from './CourseView.vue'
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case '1':
              return <a-tag color="#87d068">常规</a-tag>
            case '2':
              return <a-tag color="#f50">选修</a-tag>
            default:
              return '- -'
          }
        }
