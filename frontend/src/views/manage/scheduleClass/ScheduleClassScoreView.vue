...
export default {
  ...
  watch: {
    dishesShow: function (value) {
      if (value) {
        this.queryStaffListByCondition(this.dishesData.classId)
      }
    }
  },
  methods: {
    queryStaffListByCondition (id) {
      this.$get('/cos/class-info/queryStudentByClassId', {classId: id}).then((r) => {
    ...
    saveScore () {
      ...
      this.dataList.forEach((item, index) => {
        ...
        item.scheduleId = this.dishesData.id
      })
      this.$post('/cos/schedule-score-record/batchSaveScore', {
        courseId: this.dishesData.courseId,
        scheduleId: this.dishesData.id,
