...
import dishesAdd from './ScheduleClassAdd.vue'
import dishesEdit from './ScheduleClassEdit.vue'
import dishesView from './ScheduleClassView.vue'
import scoreView from './ScheduleClassScoreView.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/schedule-class-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/schedule-class-info/page', {
        ...params
      }).then((r) => {
