...
import dishesAdd from './ElectiveScoreAdd.vue'
import dishesEdit from './ElectiveScoreEdit.vue'
import dishesView from './ElectiveScoreView.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/elective-score-record/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/elective-score-record/page', {
        ...params
      }).then((r) => {
