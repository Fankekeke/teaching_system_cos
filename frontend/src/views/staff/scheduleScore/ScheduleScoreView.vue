<template>
  <a-modal v-model="show" title="课程分数详情" @cancel="onClose" :width="1000">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="dishesData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>课程分数主题：</b>
          {{ dishesData.title ? dishesData.title : '- -' }}
        </a-col>
        <a-col :span="8"><b>课程分数地址：</b>
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;" v-if="staffList.length !== 0">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">课程分数邀请人</span></a-col>
        <a-row :gutter="15">
...
export default {
  ...
  methods: {
    queryStaffListByCondition (id) {
      this.$get('/cos/schedule-score-record/queryStaffListByCondition', {conditionId: id}).then((r) => {
