...
import dishesAdd from './ScheduleScoreAdd.vue'
import dishesEdit from './ScheduleScoreEdit.vue'
import dishesView from './ScheduleScoreView.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/schedule-score-record/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/schedule-score-record/page', {
        ...params
      }).then((r) => {
