...
import dishesAdd from './ReserveAdd.vue'
import dishesEdit from './ReserveEdit.vue'
import dishesView from './ReserveView.vue'
...
export default {
      ...
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            ...
            case '1':
              return <a-tag color="#108ee9">通过</a-tag>
            case '2':
              return <a-tag color="#f50">驳回</a-tag>
            default:
              return '- -'
          }
        }
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/course-reserve-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/course-reserve-info/page', {
        ...params
      }).then((r) => {
